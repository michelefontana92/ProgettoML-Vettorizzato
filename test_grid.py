...
plt.fill_between(range(0,500),np.reshape(best_mean_err_tr - best_std_err_tr,500,-1),np.reshape(best_mean_err_tr + best_std_err_tr,500,-1),
                 color="b",alpha=0.4)


plt.fill_between(range(0,500),np.reshape(best_mean_err_vl - best_std_err_vl,500,-1),np.reshape(best_mean_err_vl + best_std_err_vl,500,-1),
...
plt.fill_between(range(0,500),np.reshape(best_mean_acc_tr - best_std_acc_tr,500,-1),np.reshape(best_mean_acc_tr + best_std_acc_tr,500,-1),
                 color="b",alpha=0.4)


plt.fill_between(range(0,500),np.reshape(best_mean_acc_vl - best_std_acc_vl,500,-1),np.reshape(best_mean_acc_vl + best_std_acc_vl,500,-1),
               color="orange",alpha=0.4)
